...
tags: Restauracja Fine_dining Menu_degustacyjne Luksusowa_restauracja Trzy_gwiazdki_Michelin Michelin_guide
restaurant: Amador
...
Trzeba się postarać, żeby tutaj trafić, bo wejście jest nieco ukryte i dość skromne. Restauracja Amador mieści się w zasadzie w piwniczce wyłożonej czerwonymi cegłami. 
...
Ponieważ jedna z Degustujących Istot nie je ryb i owoców morza, to zaproponowano jej inne danie główne z poza menu. Które bardzo tej Istocie przypadło do gustu. Wołowina z żelem mango i jagodową kruszonką.  _5&nbsp;[bakłażanów]._
<center><div style="width:65%">
...
<center><div style="width:50%">
<img src="{{site.img_url}}/assets/img/posts/Am_pigoenA.jpg" alt="Biały talerz przypominający oponę w którego środku znajduje się beżowa biana posypana czarnym pudrem."
height="200px" width="40px" />
</div></center>
<br />&ensp;&ensp;

...
7. Podejście komplikacji żywieniowych : 10/30 - marnie, jak chodzi o propozycje dla wegan i wegetarian. Co prawda na pytanie czy dostosują menu degustacyjne do wykluczeń żywieniowych, odpowiedź była twierdząca (stąd + 10), ale z menu ciężko coś wybrać roślinożercom.

## W sumie ISTO otrzymuje punktów: 220/250
Link do [ISTO]
